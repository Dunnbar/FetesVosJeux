...
@section('page')
    <div class="container youplay-store">
        <div class="col-md-8 pr-50">
            <article>
                <h2 class="mt-0">Description Pack Anniversaire</h2><div class="side-block"><h4 class="block-title" style="width: 80px">$15</h4></div>
                <div class="description">
                    <p> Vous connaissez quelqu'un qui adore les jeux vidéos ? Vous êtes en panne d'inspiration pour une bonne idée cadeau ? Offrez-lui un mini Mario personnalisé ! 🎁 </p>
                    <p> Comment ça marche ? 🕵️ <br>
                        Vous avez la possibilité de modifier plusieurs éléments du niveau : personnage principal, ennemi, message d'introduction...tous les éléments customisables sont détaillés dans les images. À vous de fabriquer le jeu que vous souhaitez avec les éléments à votre disposition ! </p>
                    <p> Vous avez la possibilité d'ajouter  jusqu'à 4 messages ou images à renseigner que le joueur devra découvrir via les coffres du niveau. </p>
                    <p> Mais c'est un vrai Mario ? 🤔 <br>
                        Le jeu reprend tous les codes d'un jeu de plateforme ou d'un Mario classique : courir, sauter sur des ennemis, attraper des pièces en cassant des blocs...et même manger un champignon pour grandir (ne faites pas ça en vrai, j'ai essayé, ça ne marche pas) 🍄  </p>
                    <p> Comment je télécharge le jeu ? 🎮 <br>
                        Vous recevrez un email vous informant des instructions à suivre quelques jours après l'achat de votre jeu, le temps que nos petits lutins travaillent ardemment à la fabrication de votre jeu sur-mesure. Le jeu sera disponible sur tablette ou téléphone Android seulement. </p>
                </div>
                    ...
                    <div class="modal-dialog modal-cadeau">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Personnalisez votre jeu - Pack Anniversaire</h4>
                            </div>
                            <div class="modal-body">
                                <div class="side-block">
                                    ...
                                    <div class="youplay-input">
                                        <textarea id="message-introduction" type="text" name="message-introduction" placeholder="Message d'introduction">Bienvenue à toi et encore joyeux anniversaire! J'espère que tu sera à la hauteur pour relever les défis qui t'attendent!</textarea>
                                    </div> 
                                </div>
                                ...
                                <div class="side-block">
                                    ...
                                    <div class="youplay-input">
                                        <textarea id="message-fin" type="text" name="search" placeholder="Votre message de fin...">Félicitations, tu as réussi à toutes les épreuves! Tu apprends (et vieillis) vite!</textarea>
                                    </div>
